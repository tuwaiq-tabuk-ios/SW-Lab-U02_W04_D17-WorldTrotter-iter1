 ...
 */
        ...
        let gradient = CAGradientLayer()
            ...
            gradient.colors = [UIColor.black.cgColor, UIColor.red.cgColor,UIColor.yellow.cgColor,UIColor.green.cgColor, UIColor.systemPink.cgColor,UIColor.systemIndigo.cgColor,UIColor.gray.cgColor]
